      ...
      <Reveal>
        <div className="relative overflow-hidden rounded-3xl p-8 md:p-16 text-white gradient-brand ">
          ...
          <div className="relative">
            <div className="font-mono text-xs uppercase tracking-[0.22em] opacity-80">
              Let's connect
            </div>
            <h2 className="mt-4 font-display text-4xl leading-tight md:text-6xl">
              {t("gotAnIdea")}
              <span className="italic"> {t("bringItOnline")}</span>
            </h2>
            <p className="mt-4 max-w-lg opacity-90">{t("gotAnIdeaPara")}</p>
            ...
            <div className="mt-8 grid gap-3 sm:grid-cols-3">
              <Button
                asChild
                size="lg"
                className="bg-[color-mix(in_oklab,var(--card)_95%,transparent)] text-muted-foreground border border-white/30"
              >
